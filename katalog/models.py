...
import uuid # do specjalnych identyfikatorow

# Create your models here.

class Gatunek(models.Model):
    nazwa = models.CharField(max_length=200, help_text="Gatunek, kategoria (np. poezja, fantastyka, przygodowa, satyra, klasyka, horror, sensacja)")
...
class Ksiazka(models.Model):
    ...
    # Uwaga Autora jeszcze nie zdefiniowalem, stad napis
    ...
    def display_gatunek(self):  # zwracam 3 gatunki tej ksiazki
